...
Use upper-case characters for mandatory periods, or the corresponding lower-case characters for optional periods, i.e. only display if non-zero. Once one optional period is shown, all the ones after that are also shown.", 'wc_simple_auctions' ),
										...
										array(
											'title' 			=> __( "Enable sealed auctions", 'wc_simple_auctions' ),
											'desc' 				=> __( 'Click here to enable sealed auctions.', 'wc_simple_auctions' ),
											'type' 				=> 'checkbox',
										...
										array(
											'title' 			=> __( "Remove pay button from reverse auctions.", 'wc_simple_auctions' ),
											'desc' 				=> __( 'Click here to enable removing pay functionality for reverse auctions.', 'wc_simple_auctions' ),
											'type' 				=> 'checkbox',
