...
wp_mail( $form['userEmail'], 'Registration Completed - Account Credentials', $message);
	...
	// public function cms_insert_notes_by_student($form = array()){
	// 	$getcourse = get_post($form['Course_id']);
	// 	$teacherID = $getcourse->post_author;
	// 	global $wpdb;
	// 	$defaults = array(
	...
	// 	$data = array(
	// 		'user_id' => $teacherID,
	// 		'meta_key' => 'cms_student_notes_by_student',
	// 		'meta_value' => $lastid,
