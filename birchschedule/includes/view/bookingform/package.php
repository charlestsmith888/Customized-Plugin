...
birch_ns( 'birchschedule.view.bookingform', function( $ns ) {
		...
		$ns->validate_client_info = function() {
			...
			if ( !$_POST['birs_client_property_street'] ) {
				$errors['birs_client_property_street'] = __( 'Property Street is required', 'birchschedule' );
			}


			if ( !$_POST['birs_client_property_city'] ) {
				$errors['birs_client_property_city'] = __( 'Property City is required', 'birchschedule' );
			}

			if ( !$_POST['birs_client_zip_code'] ) {
				$errors['birs_client_zip_code'] = __( 'Zip Code is required', 'birchschedule' );
			}

			if ( !$_POST['birs_client_size_sf'] ) {
				$errors['birs_client_size_sf'] = __( 'Size SF is required', 'birchschedule' );
			}

			if ( !$_POST['birs_client_year_built'] ) {
				$errors['birs_client_year_built'] = __( 'Year Built is required', 'birchschedule' );
			}
			if ( !$_POST['birs_client_services'] ) {
				$errors['birs_client_services'] = __( 'Atleast one service is required', 'birchschedule' );
			}
...
?>
				...
				<li class="birs_form_field birs_apt_time">
					<label><?php echo 'Time'; ?></label>
					<div class="birs_field_content">
						<select name="birs_appointment_apt_time" id="birs_appointment_apt_time">
							<option value="9:00am to 1:00pm">9:00am to 1:00pm</option>
							<option value="2:30pm to 6:30pm">2:30pm to 6:30pm</option>
						</select>
					</div>
					<div class="birs_error" id="birs_apt_time_error"></div>
				</li>
				...
				<li class="birs_form_field birs_client_property_street">
					<label><?php echo 'Property Street'; ?></label>
					<div class="birs_field_content">
						<input id="birs_client_property_street" name="birs_client_property_street" type="text">
						<input type="hidden" name="birs_client_fields[]" value="_birs_client_property_street" />
					</div>
					<div class="birs_error" id="birs_client_property_street_error"></div>
				</li>


				<li class="birs_form_field birs_client_property_city">
					<label><?php echo 'Property City'; ?></label>
					<div class="birs_field_content">
						<input id="birs_client_property_city" name="birs_client_property_city" type="text">
						<input type="hidden" name="birs_client_fields[]" value="_birs_client_property_city" />
					</div>
					<div class="birs_error" id="birs_client_property_city_error"></div>
				</li>


				<li class="birs_form_field birs_client_zip_code">
					<label><?php echo 'Zip Code'; ?></label>
					<div class="birs_field_content">
						<input id="birs_client_zip_code" name="birs_client_zip_code" type="text">
						<input type="hidden" name="birs_client_fields[]" value="_birs_client_zip_code" />
					</div>
					<div class="birs_error" id="birs_client_zip_code_error"></div>
				</li>

				<li class="birs_form_field birs_client_size_sf">
					<label><?php echo 'Size (SF)'; ?></label>
					<div class="birs_field_content">
						<input id="birs_client_size_sf" name="birs_client_size_sf" type="text">
						<input type="hidden" name="birs_client_fields[]" value="_birs_client_size_sf" />
					</div>
					<div class="birs_error" id="birs_client_size_sf_error"></div>
				</li>

				<li class="birs_form_field birs_client_year_built">
					<label><?php echo 'Year Built'; ?></label>
					<div class="birs_client_field_content">
						<input id="birs_client_year_built" name="birs_client_year_built" type="text">
						<input type="hidden" name="birs_client_fields[]" value="_birs_client_year_built" />
					</div>
					<div class="birs_error" id="birs_client_year_built_error"></div>
				</li>

				<li class="birs_form_field birs_client_services">
					<label><?php echo 'Services'; ?></label>
					<div class="birs_field_content">
						<?php
						$predefined_services = array('Slab Foundation','Pier & Beam Foundation','WDI/Termite Inspection','Lawn Sprinklers',
							'Swimming Pool/Spa - Inground','Swimming Pool - Above Ground','Hot Tub','Septic System','De-Winterization');
						foreach($predefined_services as $key => $services):
						?>
						<div>
							<input id="birs_client_services<?php echo $key;?>" name="birs_client_services[]"
								   value="<?php echo $services;?>" type="checkbox"><?php echo $services;?>
						</div>
						<?php
						endforeach;
						?>
						<!--<div>
							<input id="birs_client_services2" name="birs_client_services[]" value="Pier & Beam Foundation"
								   type="checkbox">Pier & Beam Foundation
						</div>
						<div>
							<input id="birs_client_services3" name="birs_client_services[]" value="WDI/Termite Inspection"
								   type="checkbox">WDI/Termite Inspection
						</div>
						<div>
							<input id="birs_client_services4" name="birs_client_services[]" value="Lawn Sprinklers"
								   type="checkbox">Lawn Sprinklers
						</div>
						<div>
							<input id="birs_client_services5" name="birs_client_services[]" value="Swimming Pool/Spa -
							Inground" type="checkbox">Swimming Pool/Spa - Inground
						</div>
						<div>
							<input id="birs_client_services6" name="birs_client_services[]" value="Swimming Pool - Above
							Ground" type="checkbox">Swimming Pool - Above Ground
						</div>
						<div>
							<input id="birs_client_services7" name="birs_client_services[]" value="Hot Tub"
								   type="checkbox">Hot Tub
						</div>
						<div>
							<input id="birs_client_services8" name="birs_client_services[]" value="Septic System"
								   type="checkbox">Septic System
						</div>
						<div>
							<input id="birs_client_services9" name="birs_client_services[]" value="De-Winterization"
								   type="checkbox">De-Winterization
						</div>-->


						<input type="hidden" name="birs_client_fields[]" value="_birs_client_services" />
					</div>
					<div class="birs_error" id="birs_client_services_error"></div>
				</li>
