...
<?php
	...
	$ns->get_client_info_html = function( $client_id ) use ( $ns ) {
		...
		$city = get_post_meta($client_id, '_birs_client_property_city', true);
		$street = get_post_meta($client_id, '_birs_client_property_street', true);
		$zip_code = get_post_meta($client_id, '_birs_client_zip_code', true);
		$size_sf = get_post_meta($client_id, '_birs_client_size_sf', true);
		$year_built = get_post_meta($client_id, '_birs_client_year_built', true);
		$services = get_post_meta($client_id, '_birs_client_services', true);
...
*/?>
					...
					<li class="birs_form_field _birs_client_property_city">
						<label for="birs_client_phone"><?php _e( 'Property City', 'birchschedule' ); ?></label>
						<div class="birs_field_content">
							<input type="text" name="birs_client_property_city" id="birs_client_property_city"
								   value="<?php echo esc_attr( $city ); ?>">
							<input type="hidden" name="birs_client_fields[]" value="_birs_client_property_city">
						</div>
						<div class="birs_error" id="_birs_client_property_city_error">
						</div>
					</li>
					<li class="birs_form_field birs_client_property_street">
						<label for="birs_client_property_street"><?php _e( 'Property Street', 'birchschedule' ); ?></label>
						<div class="birs_field_content">
							<input type="text" name="birs_client_property_street" id="birs_client_property_street"
								   value="<?php echo esc_attr( $street ); ?>">
							<input type="hidden" name="birs_client_fields[]" value="_birs_client_property_street">
						</div>
						<div class="birs_error" id="birs_client_property_street_error">
						</div>
					</li>
					<li class="birs_form_field birs_client_zip_code">
						<label for="birs_client_zip_code"><?php _e( 'Zip code', 'birchschedule' ); ?></label>
						<div class="birs_field_content">
							<input type="text" name="birs_client_zip_code" id="birs_client_zip_code"
								   value="<?php echo esc_attr( $zip_code ); ?>">
							<input type="hidden" name="birs_client_fields[]" value="_birs_client_zip_code">
						</div>
						<div class="birs_error" id="birs_client_zip_code_error">
						</div>
					</li>
					<li class="birs_form_field birs_client_size_sf">
						<label for="birs_client_size_sf"><?php _e( 'Size (SF)', 'birchschedule' ); ?></label>
						<div class="birs_field_content">
							<input type="text" name="birs_client_size_sf" id="birs_client_size_sf"
								   value="<?php echo esc_attr( $size_sf ); ?>">
							<input type="hidden" name="birs_client_fields[]" value="_birs_client_size_sf">
						</div>
						<div class="birs_error" id="birs_client_size_sf_error">
						</div>
					</li>
					<li class="birs_form_field birs_client_year_built">
						<label for="birs_client_year_built"><?php _e( 'Year Built', 'birchschedule' ); ?></label>
						<div class="birs_field_content">
							<input type="text" name="birs_client_year_built" id="birs_client_year_built"
								   value="<?php echo esc_attr( $year_built ); ?>">
							<input type="hidden" name="birs_client_fields[]" value="_birs_client_year_built">
						</div>
						<div class="birs_error" id="birs_client_year_built_error">
						</div>
					</li>
					<li class="birs_form_field birs_client_services">
						<label for="birs_client_services"><?php _e( 'Services', 'birchschedule' ); ?></label>
						<div class="birs_field_content">
							<?php
						...
						foreach($predefined_services as $key => $service){
							?>

								<input type="checkbox" name="birs_client_services[]" id="birs_client_services<?php echo $key;?>" value="<?php echo esc_attr( $service ); ?>"<?php if(in_array($service, $services)) echo ' checked';?>> <?php echo esc_attr( $service );
							?><br />
						...
						<div class="birs_error" id="birs_client_services_error">
						</div>
					</li>
                </ul>
<?php
