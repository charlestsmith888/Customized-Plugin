...
.item-list ul, .carrier-list { padding: 0; margin: 0 -15px 1em; }
...
.carrier-list .pane2:hover {
    -webkit-box-shadow: 0 3px 15px #b7b6b6;
    box-shadow: 0 3px 15px #b7b6b6;
}
.pane2:hover {
    border-color: #ababab;
}
...
.table-summary thead th, #cart-pane thead th, .order-pane thead th {
...
<div class="view-content">
	<ul class="carrier-list t-center">
		<?php
		$q = new WP_Query(array('post_type' => array('customform'),) ); ?>
...
<div class="col span_12">
  <a class="backbtn" href="https://dev5.onlinetestingserver.com/huaren/carrier/" class="link-back">Back</a>
</div>
...
<div class="col span_5 center-col">
	<form action="?cart=true" method="post" id="prepaid-order-enter-phone-form" accept-charset="UTF-8">
		<div class="form-item form-type-telfield form-item-phone">
			...
			<input class="inptxt form-control bfh-phone form-text form-tel required" data-format="(ddd) ddd-dddd" type="tel" id="edit-phone" name="phone" value="" size="20" maxlength="17">
		</div>
			...
			<ul class="carrier-list t-center">
				<li>
					<div class="pane2 pane-plan">
						<a href="javascript:;">
							<strong class="price" style="background: #99cc33;">$<?php echo $data->meta_value[0]; ?></strong>
...
<div class="col span_12">
<a class="backbtn" href="https://dev5.onlinetestingserver.com/huaren/carrier/?step2=true&compid=<?php echo $data->post_id; ?>">Back</a>
</div>
...
<!-- step 3 -->
<?php if (!empty($_GET['cart'])): if (empty($_POST['phone'])) {echo "<script>window.location = 'https://dev5.onlinetestingserver.com/huaren/carrier/';</script>";} $id = $_POST['meteaid']; ?>
      ...
      <table>
         ...
         <tbody>
            <tr class="odd">
               ...
               <td><span class="uc-price">$<?php echo $data->meta_value[0]; ?></span></td>
               <td><span class="uc-price">$<?php echo $data->meta_value[0]; ?></span></td>
            </tr>
         </tbody>
      </table>
...
<form action="https://dev5.onlinetestingserver.com/huaren/process/" method="POST">
...
<input type="hidden" name="item[amount]" value="<?php echo $data->meta_value[0]; ?>">
            ...
            <div class="uc-store-address-field form-wrapper" id="edit-panes-billing-address">
               <div class="row">
                  <label for="edit-panes-billing-billing-first-name">First name*:</label>
                     <input class="name form-text required" type="text" id="edit-panes-billing-billing-first-name" name="payment[firstname]" value="" size="32" maxlength="128">      
               </div>
               <div class="row">
                  <label for="edit-panes-billing-billing-last-name">Last name*:</label>
                     <input class="middle form-text required" type="text" id="edit-panes-billing-billing-last-name" name="payment[lastname]" value="" size="32" maxlength="128">      
               </div>
               <div class="row">
                  <label for="edit-panes-customer-primary-email">E-mail address:</label>
                     <input type="text" id="edit-panes-customer-primary-email" name="billing[primary_email]" value="" size="32" maxlength="64" class="form-text required">      
               </div>
               <div class="row">
                  <label for="edit-panes-billing-billing-street1">Street address*:</label>
                     <input class="street form-text required" type="text" id="edit-panes-billing-billing-street1" name="billing[billing_street1]" value="" size="32" maxlength="128">      
               </div>
               <div class="row">
                  <label for="edit-panes-billing-billing-city">City*:</label>
                     <input class="middle form-text required" type="text" id="edit-panes-billing-billing-city" name="billing[billing_city]" value="" size="32" maxlength="128">      
               </div>
               <div class="row">
                  <label for="edit-panes-billing-billing-zone">State/Province*:</label>
                     <div class="selector fixedWidth" id="uniform-edit-panes-billing-billing-zone">
                        <select id="edit-panes-billing-billing-zone" name="billing[billing_zone]" >
               ...
               <div class="row">
                  <label for="edit-panes-billing-billing-postal-code">Zip Code*:</label>
                     <input class="code form-text form-tel required" type="tel" id="edit-panes-billing-billing-postal-code" name="billing[billing_postal_code]" value="" size="10" maxlength="5">      
               </div>
            </div>
         </div>
      </div>
...
<div class="col span_6">
	...
	<label class="element-invisible" for="edit-panes-payment-payment-method">Payment method <span class="form-required" title="This field is required.">*</span></label>
	<div id="edit-panes-payment-payment-method" class="form-radios">
		<label class="option" for="edit-panes-payment-payment-method-paypal-wps">
			<input type="radio" checked="checked" id="edit-panes-payment-payment-method-paypal-wps" class="form-radio ajax-processed">
			<img style="margin-bottom: -4px;" src="https://www.paypal.com/en_US/i/logo/PayPal_mark_37x23.gif" alt="PayPal" class="uc-credit-cctype"> PayPal
		</label>
	</div>
...
<select id="exp-year" name="payment[cc_exp_year]" >
   ...
   <option value="2037">2037</option>
	...
	<input type="submit" value="Submitu">
</div>
...
<div class="col span_12">
	<a class="backbtn" href="https://dev5.onlinetestingserver.com/huaren/carrier/?step3=true&select=<?php echo $id; ?>">Back</a>
</div>
