...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/pay/jquery.inputmask.bundle.js" charset="utf-8"></script>
<script type="text/javascript">

jQuery('input[type="radio"]').change(function() {
	if(jQuery(this).attr('id') == 'my-authorizeee') {
		jQuery('.my-credittt').show('swing');
		jQuery(".my-credittt input").attr("required", "");
		jQuery(".my-credittt select").attr("required", "");
	}
	else {
		jQuery(".my-credittt input").removeAttr('required');
		jQuery(".my-credittt select").removeAttr('required');
		jQuery('.my-credittt').hide('swing');
	}
});

jQuery('#prepaid-order-enter-phone-form input[type="radio"]').change(function() {
	
	jQuery("#option1 input").removeAttr('required');
	jQuery("#option2 input").removeAttr('required');


	if(jQuery(this).attr('id') == 'my-opt-1') {
		jQuery("#option1 input").attr("required", "");
	}
	else{
		jQuery("#option2 input").attr("required", "");
	}
});


jQuery('#inputphoneNumber').inputmask("(999) 999-9999");
</script>
